...
```bash
lairpeteryksong@Lair5080Peter:~/lio_ws/dataset/walking_dataset_ros2$ ros2 bag info walking_dataset_ros2.db3 
```
...
Terminal 1
```bash
lairpeteryksong@Lair5080Peter:~/lio_ws/dataset$ ros2 bag play walking_dataset_ros2   --clock
```
